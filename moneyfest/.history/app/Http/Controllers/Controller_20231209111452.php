...
class Controller extends BaseController
{
    ...
    public function tes_dashboard()
    {
        ...
        //     $map_kategori[$key['kategori']] = $i;
        //     $i++;
        // }

        $orders = Keuangan::select(DB::raw('*, SUM(nominal * jumlah) as total'))
    ->selectRaw("DATE_FORMAT(tanggal, '%M %Y') as months, DATE_FORMAT(tanggal, '%m') as monthKey")
