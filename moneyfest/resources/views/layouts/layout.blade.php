...
<header class="header header-transparent header-sticky">
    <nav class="navbar navbar-sticky navbar-expand-lg" id="primary-menu">
      <div class="container"> <a class="logo navbar-brand" href="index.html"><img class="logo logo-dark" style="width: 120px; height:50px"  src="assets/images/logo/logo-dark.png" alt="Ebookyo Logo"/><img class="logo logo-light" style="width: 120px; height:50px" src="assets/images/logo/logo-light.png" alt="Ebookyo Logo"/></a>
