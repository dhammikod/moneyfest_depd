            ...
            <div class="row">
              <div class="col-12 col-md-8 offset-md-2 col-lg-8 offset-lg-2">
                <div class="hero-content text-center pt-0">
                  ...
                  <div class="hero-bio">we have on the web development market since 2000 and have been growing ever since.<Br> A design studio founded in London and expanded our services.</div>
                  <div class="hero-action"><a class="btn btn--secondary btn--hover-white btn--auto mx-auto" href="javascript:void(0)"> <span>download Now</span></a></div>
                </div>
              </div>
            </div>
            <!-- End .row-->
