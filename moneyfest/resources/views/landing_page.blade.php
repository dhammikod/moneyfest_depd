        ...
        <div class="container">
          <div class="hero-cotainer">
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6 ps-4"><img class="img-fluid float-right" src="assets/images/cover/book.png" alt="Book Cover"/></div>
            </div>
            <!-- End .row-->
          </div>
          <!-- End .hero-cotainer-->
          ...
          <div class="row align-items-center h-100">
            <div class="col-12 col-md-12 col-lg-6">
              <div class="heading">
                ...
                <p class="heading-desc"> Is an intelligent income and expense tracking platform powered by AI. Our business revolves around offering a money management website, but with a unique twist. We provide users with the ability to not only record their financial transactions but also harness the predictive capabilities of artificial intelligence.</p>
              </div>
